...
<body>
    ...
    justify-content-between">
            ...
            <img src="img/oc logo.png" alt="" width="50" height="50" class="me-2">
                <h1><a href="index.html">PT Kue Apem</a> </h1> <!-- Uncomment below if
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    <h1 data-aos="fade-up">JKT48, Ronaldo & Messi Pernah Beli Disini!!!!!...</h1>
                    <h2 data-aos="fade-up" data-aos-delay="400">Toko buka dimulai hari Senin - Jum'at, Hari Kiamat Libur</h2>
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="/login" class="btn-get-started scrollto">Ayo Gabung</a>
                    </div>
                </div>
                <div class="col-lg-6 order-1 order-lg-2 hero-img" data-aos="fade-left" data-aos-delay="200">
                    <img src="img/kue1.jpg" class="img-fluid animated" alt="" width="10000" height="10000">
                </div>
            </div>
        </div>
